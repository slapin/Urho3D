...
void CreateInstructions()
{
    ...
    instructionText.text = "Use WASD keys to drive, F to brake, mouse/touch to rotate camera\n"
...
class Vehicle : ScriptObject
{
	...
	RaycastVehicle@ raycastVehicle = node.CreateComponent("RaycastVehicle");
        ...
        for (int id = 0; id < connectionPoints.length; id++)
        {
            ...
            raycastVehicle.AddWheel(wheelNode, wheelDirection, wheelAxle, m_fsuspensionRestLength, wheelRadius, isFrontWheel);
